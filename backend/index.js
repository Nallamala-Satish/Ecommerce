...
//Image storage Engine
  ...
  //Creating upload endpoind for images
  ...
  app.post('/removeproduct',async (req,res)=>{
   ...
   //createing API for getting all prducts
  ...
  app.post('/signup',async(req,res)=>{
       ...
       if(check){
         return res.status(400).json({success:false,errors:"existing user found with same Email Id address"});
       }
        let cart={};
        for(let i=0;i< 300 ; i++){
          cart[i]=0;
  ...
  // creating endpoint of newcollection data
  ...
  // creating endpoint of popular in women section
  ...
  const fetchUser = async(req,res,next)=>{
   ...
   // creating endpoint of adding products in cartdata
